...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-header">
        <h2><i class="fa-solid fa-user me-2"></i>Multas por Infractor</h2>
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <asp:Button ID="btnDescargar"
                            runat="server"
                            Text="⬇ Excel"
                            CssClass="btn btn-outline-danger w-50"
        ...
        <div class="card shadow border-0 mb-5">
            ...
            <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <asp:Label ID="lblDeudaTotal"
                        runat="server"
                        CssClass="badge bg-light text-danger fs-6">
                    </asp:Label>

                    <asp:Label ID="lblCantidad"
                        runat="server"
                        CssClass="badge bg-white text-danger fs-6">
                    </asp:Label>
            ...
            <div class="card-body table-responsive">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <asp:Label ID="lblPagina"
                        runat="server"
                        CssClass="fw-bold fs-5 text-danger">
                    </asp:Label>
